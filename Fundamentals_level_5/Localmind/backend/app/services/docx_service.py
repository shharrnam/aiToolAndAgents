"""
DOCX Service - Extract text from Word documents.

Educational Note: This service extracts text from DOCX files using python-docx.
...
class DocxService:
    ...
    Educational Note: We use python-docx to parse Word documents.
    The extraction preserves document structure in a markdown-like format
    for better semantic understanding in RAG applications.
    """

    def __init__(self):
        """Initialize the DOCX service."""
        if not DOCX_AVAILABLE:
            print("DocxService: python-docx not available")
    ...
    def extract_text_from_docx(
        ...
        Educational Note: This method reads the DOCX file and extracts:
        ...
        try:
            ...
            extracted_text = self._extract_document_content(doc)
    ...
    def _extract_document_content(self, doc: 'Document') -> str:
        ...
        for element in doc.element.body:
            ...
            if element.tag.endswith('p'):
                ...
                para_text = self._extract_paragraph(para)
                if para_text:
