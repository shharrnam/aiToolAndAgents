...
It uses existing services for consistency:
    - prompt_service: Load agent system prompt
...
from app.services.web_agent_executor import web_agent_executor
...
class WebAgentService:
    ...
    def _get_system_prompt(self) -> str:
        """
        Load system prompt using prompt_service.

        Returns:
            System prompt string
        """
        prompt = prompt_service.get_agent_prompt(self.AGENT_NAME)
        if not prompt:
            # Fallback prompt
            prompt = (
