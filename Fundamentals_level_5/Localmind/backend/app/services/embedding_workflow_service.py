"""
Embedding Workflow Service - Orchestrates the full embedding pipeline.
...
Flow:
    Source processed → embedding_workflow_service.process_embeddings() →
...
class EmbeddingWorkflowService:
    """
    ...
    def __init__(self):
        """Initialize the embedding workflow service."""
        pass
    ...
    def process_embeddings(
        ...
        try:
            ...
            chunks = chunking_service.parse_extracted_text(
                text=processed_text,
                source_id=source_id,
            ...
            saved_paths = chunking_service.save_chunks_to_files(
                chunks=chunks,
            ...
            vectors = chunking_service.chunks_to_pinecone_format(chunks, embeddings)
    ...
    def delete_embeddings(
        ...
        # Delete chunk files
        deleted_count = chunking_service.delete_chunks_for_source(
            source_id=source_id,
            chunks_dir=chunks_dir
        )
    ...
    def search_similar(
        ...
        try:
            ...
            for result in search_results:
                ...
                chunk_data = chunking_service.load_chunk_by_id(
                    chunk_id=chunk_id,
                    chunks_dir=chunks_dir
                )
...
embedding_workflow_service = EmbeddingWorkflowService()
