...
from app.utils.path_utils import get_studio_audio_dir, get_studio_dir
...
@api_bp.route('/projects/<project_id>/studio/website', methods=['POST'])
...
@api_bp.route('/projects/<project_id>/studio/website-jobs/<job_id>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/website-jobs', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/websites/<job_id>/<path:filename>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/websites/<job_id>/preview', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/websites/<job_id>/download', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/components', methods=['POST'])
...
@api_bp.route('/projects/<project_id>/studio/component-jobs/<job_id>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/component-jobs', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/components/<job_id>/preview/<filename>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/videos', methods=['POST'])
...
@api_bp.route('/projects/<project_id>/studio/videos/<job_id>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/videos', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/videos/<job_id>/preview/<filename>', methods=['GET'])
...
@api_bp.route('/projects/<project_id>/studio/videos/<job_id>/download/<filename>', methods=['GET'])
