"""
Tier Configuration Utility - Centralized API tier management.

Educational Note: This utility manages rate limit tiers for various APIs:
...
This utility provides a single source of truth for tier configurations.
"""
import os
